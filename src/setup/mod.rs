...
"#;
        ...
        assert_eq!(res.data_folder, PathBuf::from("/home/steve/Data/MDR source data/NHS Org Data/2025 October/"));
        assert_eq!(res.log_folder, PathBuf::from("/home/steve/Data/MDR/MDR_Logs/nhs"));
